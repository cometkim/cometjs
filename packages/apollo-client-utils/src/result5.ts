...
/**
 * This utility helps to make behavior more predictable and type-safety by restricting some options and variants. (1-Query, 5-Variants)
 *
...
export function useQuery5<
  TData = unknown,
  TVariables extends Record<string, unknown> = Record<string, unknown>,
>({ query, ...args }: UseQuery5Args<TData, TVariables>): Result5<TData> {
